...
(function(c,X,fa,T){var ctime = function(a,min){var h, m, t;t="";h = Math.floor((a/60)%60);if(h!=0){t+=h+"h ";}m=Math.floor(a%60);if(((min==true)&&(m!=0))||(min==false)){t+=m+"m";}if(t==""){t+="0m";}return t;};var Y=0,O=function(){var c=T.userAgent,a=/msie\s\d+/i;return 0<c.search(a)&&(c=a.exec(c).toString(),c=c.split(" ")[1],9>c)?!0:!1}(),H;try{X.createEvent("TouchEvent"),H=!0}catch(ha){H=!1}var N={init:function(m){var a=c.extend({min:10,max:100,from:null,to:null,type:"single",step:1,prefix:"",postfix:"",hasGrid:!1,hideMinMax:!1,hideFromTo:!1,prettify:!0,onChange:null,onLoad:null,onFinish:null},m),r='<div class="irs">',r=r+'<div class="irs-line"><div class="irs-line-left"></div><div class="irs-line-mid"></div><div class="irs-line-right"></div></div>',
r=r+'<div class="irs-min">0</div><div class="irs-max">1</div>',r=r+'<div class="irs-from">0</div><div class="irs-to">0</div><div class="irs-single">0</div>',r=r+"</div>",r=r+'<div class="irs-grid"></div>',I='<div class="irs-diapason"></div>',I=I+'<div class="irs-slider from"></div>',I=I+'<div class="irs-slider to"></div>';return this.each(function(){var d=c(this),m=this;if(!d.data("isActive")){d.data("isActive",!0);this.pluginCount=Y+=1;d.prop("value")&&(a.min=parseInt(d.prop("value").split(";")[0],
...
typeof a.onChange&&a.onChange.call(this,g);"function"!==typeof a.onFinish||v||P||a.onFinish.call(this,g);"function"===typeof a.onLoad&&!v&&P&&a.onLoad.call(this,g)},ga=function(){x.addClass("irs-with-grid");var b,c="",d=0,d=0,e="";for(b=0;20>=b;b+=1)d=Math.floor(k/20*b),d>=k&&(d=k-1),e+='<div class="irs-grid-pol small" style="left: '+d+'px;"></div>';for(b=0;4>=b;b+=1)d=Math.floor(k/4*b),d>=k&&(d=k-1),e+='<div class="irs-grid-pol" style="left: '+d+'px;"></div>',p?(c=a.min+(a.max-a.min)/4*b,c=c/
a.step*a.step,c=parseInt(c*p,10)/p):(c=Math.round(a.min+(a.max-a.min)/4*b),c=Math.round(c/a.step)*a.step,c=w(c)),0===b?e+='<div class="irs-grid-text" style="left: '+d+'px; text-align: left;">'+c+"</div>":4===b?(d-=100,e+='<div class="irs-grid-text" style="left: '+d+'px; text-align: right;">'+c+"</div>"):(d-=50,e+='<div class="irs-grid-text" style="left: '+d+'px;">'+c+"</div>");$.html(e)};ba()}})},update:function(c){return this.each(function(){this.updateData(c)})},remove:function(){return this.each(function(){this.removeSlider()})}};
